...
public class ProdutosControllerTest {
	...
	public void somenteAdminDeveAcessarProdutosForm() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/produtos/form").with(
				SecurityMockMvcRequestPostProcessors.user("hugo.iguanaa@gmail.com").password("admin").roles("USUARIO")))

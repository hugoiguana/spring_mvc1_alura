	...
	<section class="container middle">
	  <h2 id="cart-title">Seu carrinho de compras</h2>
		  ...
		  <c:forEach items="${carrinhoCompras.itens }" var="item">
		   <tr>
		       ...
		       <td class="remove-item">
				...
				<c:url value="/carrinho/remover/${item.produto.id}/${item.tipoPreco}" var="carrinhoRemover"/>
				<form:form action="${carrinhoRemover}" method="post">		       	
		...
		<tfoot>
		    <tr>
		        <td colspan="3">
		        	<c:url value="/pagamento/finalizar" var="pagamentoFinalizar"/>
		        	<form:form action="${pagamentoFinalizar}" method="post">
		  ...
		  <h2><a href="${s:mvcUrl('produtosListar').build()}">Veja todos os livros que publicamos!</a></h2>
		</section> 
	</jsp:body>		
</tags:pageTemplate>